...
@Component({
  selector: 'app-others-fus',
  templateUrl: './others-fus.component.html',
  styleUrls: ['./others-fus.component.scss']
})
export class OthersFusComponent implements OnInit {
  @Input() dataId: any;
  list: any;
  listCount: Number = 4;
  loader: Boolean = true;
  ...
  ngOnInit() {
    this.siteSer.getOthersFu(this.dataId).subscribe(retData => {
